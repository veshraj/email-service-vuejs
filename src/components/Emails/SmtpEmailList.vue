        ...
        <main>
            ...
            <div class="container-fluid">
              <div class="page-header-content">
                <h1 class="page-header-title">
                  ...
                  <span>Email Sent via SMTP List</span>
                </h1>
                <div class="page-header-subtitle">Email Sent via SMTP List</div>
              </div>
            </div>
          </div>
          <div class="container-fluid mt-n10">
            <div class="card mb-4">
              ...
              <div class="card-body">
                <router-link to="/compose/smtp-email" class="btn btn-primary btn-lg mb-3"> Compose Email</router-link>
