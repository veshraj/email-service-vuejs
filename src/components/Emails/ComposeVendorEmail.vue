              ...
              <div class="card-body">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input class="form-control" id="from" v-model="form.from"  readonly type="email" placeholder="name@example.com">
                        <small v-if="errors.form" class="text-danger text-bold">{{ errors.from }}</small>
                    </div>
                    <div class="form-group">
                        <label for="from">To </label>
                        <input class="form-control" id="from" v-model="form.to" type="email" placeholder="name@example.com">
...
export default {
  ...
  data: function() {
    return {
      composeVendorEmail: "api/vendor/emails",
      errors: {},
      form: {
  ...
  methods: {
    submitForm: function() {
      var url = this.$store.state.serverUrl + "/" + this.composeVendorEmail;
      this.formValidate();
